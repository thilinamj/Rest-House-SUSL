...
$query="INSERT INTO geomatics(name,email,phone,Package,adate,ddate)values('$name','$email','$phone','$Package','$adate','$ddate')";
...
<nav class="navbar navbar-inverse header-nav">
  ...
  <h4 class="alert-heading">Faculty of Geomatics</h4>
...
<form action="geomatics.php" method="post">
